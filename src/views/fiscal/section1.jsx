...
function  Section1(){
    return(
        ...
        <div class="mx-auto efar py-32 sm:py-48 lg:py-56">
         
          <div class="">
            <h1 class=" text-center text-4xl font-bold tracking-tight text-gray-900 bi sm:text-6xl">Representante fiscal de Portugal</h1>
          <p class="mt-6 text-lg leading-8 text-gray-600 mt-5">
